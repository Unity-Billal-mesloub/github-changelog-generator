...
[![Ruby CI](https://github.com/Unity-Billal-mesloub/github-changelog-generator/actions/workflows/test.yml/badge.svg)](https://github.com/Unity-Billal-mesloub/github-changelog-generator/actions/workflows/test.yml)
...
# github-changelog-generator ![GitHub Logo](../main/images/logo.jpg)
...
- Look at **[CHANGELOG.md](https://github.com/Unity-Billal-mesloub/github-changelog-generator/blob/main/CHANGELOG.md)** for this project
- [ActionSheetPicker-3.0/CHANGELOG.md](https://github.com/Unity-Billal-mesloub/ActionSheetPicker-3.0/blob/develop/CHANGELOG.md) was generated by command:

      $ github_changelog_generator -u github-changelog-generator -p ActionSheetPicker-3.0

- In general, it looks like this:

> ## [1.2.5](https://github.com/Unity-Billal-mesloub/github-changelog-generator/tree/1.2.5) (2015-01-15)
>
> [Full Changelog](https://github.com/Unity-Billal-mesloub/github-changelog-generator/compare/1.2.4...1.2.5)
>
> **Implemented enhancements:**
>
> - Use milestone to specify in which version bug was fixed [issues](https://github.com/Unity-Billal-mesloub/github-changelog-generator/issues)
>
> **Fixed bugs:**
>
> - Error when trying to generate log for repo without tags [issues](https://github.com/Unity-Billal-mesloub/github-changelog-generator/issues)
>
> **Merged pull requests:**
>
> - PrettyPrint class is included using lowercase 'pp' [issues](https://github.com/Unity-Billal-mesloub/github-changelog-generator/pull) ([schwing](https://github.com/Unity-Billal-mesloub))
>
> - support enterprise github via command line options [issues](https://github.com/Unity-Billal-mesloub/github-changelog-generator/pull) ([glenlovett](https://github.com/Unity-Billal-mesloub))
...
For more details about params, read the Wiki page: [**Advanced changelog generation examples**](https://github.com/github-changelog-Unity-Billal-mesloub/github-changelog-generator/wiki/Advanced-change-log-generation-examples)
...
You can look for params names from the [parser source code (#setup_parser)](https://github.com/Unity-Billal-mesloub/github-changelog-generator/blob/main/lib/github_changelog_generator/parser.rb). For example, to translate the bugs label to Portuguese, instead of setting `config.bugs_label`, you have to set `config.bug_prefix`, and so on.
...
> [Full Changelog](https://github.com/Unity-Billal-mesloub/github-changelog-generator/compare/0.1.0...1.0.0)
>
> ![image](https://user-images.githubusercontent.com/12690315/45935880-006a8200-bfeb-11e8-958e-ff742ae66b96.png)
>
> Hello, World! :tada:
...
Here is a [wikipage list of alternatives](https://github.com/Unity-Billal-mesloub/github-changelog-generator/wiki/Alternatives) that I found. But none satisfied my requirements.
...
Here's a [wikipage list of projects](https://github.com/Unity-Billal-mesloub/github-changelog-generator/wiki/Projects-using-GitHub-Changelog-Generator).

If you've used this project in a live app, please let me know! Nothing makes me happier than seeing someone else take my work and go wild with it.

*If you are using `github_changelog_generator` to generate your project's changelog, or know of other projects using it, please [add it to this list](https://github.com/Unity-Billal-mesloub/github-changelog-generator/wiki/Projects-using-GitHub-Changelog-Generator).*
...
- Open an [issue](https://github.com/Unity-Billal-mesloub/github-changelog-generator/issues/new/choose) and let's make the generator better together!
...
*BTW: I would like to support GitHub Releases in [next releases](https://github.com/Unity-Billal-mesloub/github-changelog-generator/issues) ;)*
...
Windows: [v1.14.0 introduced a bug where it attempts to create /tmp/github_changelog-logger.log... which isn't a valid path on Windows and thus fails](https://github.com/Unity-Billal-mesloub/github-changelog-generator/issues)
